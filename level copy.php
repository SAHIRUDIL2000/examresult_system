  ...
  <script>
    ...
    function displayData(data) {
      ...
      for (const key in data) {
       ...
       subCodeL.innerHTML=data[key][0];
       subCodeL.name="sc"+i;
       subNameL.innerHTML=data[key][1];
       subNameL.name="sn"+i;
       GradeL.innerHTML=data[key][2];
       GradeL.name="gd"+i;
       subCode.appendChild(subCodeL);
       subName.appendChild(subNameL);
       Grade.appendChild(GradeL);
  ...
  <div>
    ...
    <form action="Download2.php" method="post">
      ...
      <tr>
          ...
          <th colspan="3"><input type="submit" value="Download Certificate"> </th>
